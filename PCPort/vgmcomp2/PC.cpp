...
// build headers
// I need to avoid windows.h as it pulls in string, which pulls MY string.h...
typedef unsigned int UINT;
typedef UINT MMRESULT;
extern "C" __declspec(dllimport) MMRESULT __stdcall timeBeginPeriod(UINT uPeriod);
...
#ifdef USE_SID_PSG
    // saving this just to remember the SID noise/tone configuration
    if (argv[arg][0] == '-') {
...
// at 60hz, you can do something like this:
