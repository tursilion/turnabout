...
{   EV_NONE,    168,    PP_BLOOM   | CMD_STOPMUS,  "..."  },
...
//      story                                    //  0                               1                               2                               3                               4                               5                               6                               7
const Story_t story[] =  {                       //  
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "The witness brought up some interesting information, but does the prosecution have anything more regarding the defendant?"   },
{   EV_NONE,     144,   PP_TRIXIE    | CMD_NONE,    "Trixie has this weather schedule..."   },

{ EV_T_YESSCHED, 144, PP_TRIXIE | CMD_ADDPROMPT, "Question relevance"     },
{ EV_T_NOSCHED,  144, PP_TRIXIE | CMD_ADDPROMPT, "Let it go"    },
{   EV_NONE,     144, PP_TRIXIE | CMD_SELPROMPT, ""  },

{EV_T_YESSCHED,  136,   PP_PHOENIX   | CMD_NONE,    "Weather schedule? Like the forecast for each day? How is that evidence?"   },
{   EV_NONE,     132,   PP_TWILIGHT  | CMD_NONE,    "It's what the weather mare is given to know what weather to make in which areas of Ponyville."   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "(I forgot about that.)"   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "(I still can't believe these ponies control weather! Sounds like some sort of twist at the end of a Twilight Zone episode)"   },

{ EV_T_NOSCHED,  142,   PP_TRIXIE    | CMD_NONE,    "Lo and behold! Rainbow Trash was scheduled to make several lightning storms at the eastern end of Ponyville; this is where she got the cloud from."   },
{   EV_NONE,     174,   PP_NONE      | CMD_NONE,   "(Weather map shows Everfree to the west and Ponyville to the east with three weather zones.)"   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "The court accepts this as evidence."   },
{   EV_WEATHER,  175,   PP_NONE      | CMD_ADDEV,   "Weather Schedule: Rainbow Dash scheduled to create a thunder storm at 3pm on the eastern side of Ponyville. Everfree Forest is on the west side of town."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_CLRPROMPT,  "(It's really starting to look like Rainbow Dash did it... but I can't give up!)"   },

{ EV_T_QMOTIVE,  139,   PP_PHOENIX   | CMD_ADDPROMPT, "Question motive"   },
{ EV_T_PTHEORY,  139,   PP_PHOENIX   | CMD_ADDPROMPT, "Question narrative"   },
{   EV_NONE,     144, PP_TRIXIE | CMD_SELPROMPT, ""  },

{ EV_T_QMOTIVE,  139,   PP_PHOENIX   | CMD_NONE,    "What about motive?"   },
{   EV_NONE,     141,   PP_TRIXIE    | CMD_NONE,    "Hmm?"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "I was told murder almost never occurs in Equestria. What could drive my client to kill another?"   },
{   EV_NONE,     144,   PP_TRIXIE    | CMD_NONE,    "Oh! That one is easy!"   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "Please explain, Ms Trixie."   },
{   EV_NONE,     144,   PP_TRIXIE    | CMD_NONE,    "Both the victim and the defendant were to participate in a monumental race called the \"Equestrian 500\"."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "Damnit! She knows!"   },
{   EV_NONE,     132,   PP_TWILIGHT  | CMD_NONE,    "Phoenix! Language!"   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "Oh, sorry..."   },
{   EV_NONE,     127,   PP_TRIXIE    | CMD_NONE,    "The victim Mr Ace Swift has quite the record, completely undefeated in every athletic event he has ever competed in."   },
{   EV_NONE,     130,   PP_JUDGE     | CMD_NONE,    "That is... impressive!"   },
{   EV_NONE,     127,   PP_TRIXIE    | CMD_NONE,    "Indeed..."   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_NONE,    "Now Rainbow Trash was probably intimidated by this and decided to get rid of him like a coward, making it easier to win."   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_NONE,    "She is the top pegasus athlete in Ponyville after all; she has a reputation to uphold."   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_NONE,    "She then could then reap the spoils of the grand prize: flight lessons from her idols, \"The Wonderbolts\"."   },
{   EV_NONE,     148,   PP_PHOENIX   | CMD_NONE,    "You have no proof that is what she was thinking!"   },
{   EV_NONE,     144,   PP_TRIXIE    | CMD_NONE,    "So? You have no proof that WASN'T what she was thinking!"   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_NONE,    "Trixie doesn't need to establish a motive. How should Trixie know why she killed him? The point is Rainbow Trash did it."   },

{ EV_T_PTHEORY,  148,   PP_PHOENIX   | CMD_NONE,    "Let's hear your explanation of how the murder went down, then."   },
{   EV_NONE,     144,   PP_TRIXIE    | CMD_NONE,    "Very well..."   },

{EV_P_RDEVERFREE,143,   PP_TRIXIE    | CMD_ADDTEST,  "Rainbow Dash went to the Everfree Forest..."   },
{EV_P_RDSEEACE,  143,   PP_TRIXIE    | CMD_ADDTEST,  "She saw Ace hanging around the forest for whatever reason..."   },
{EV_P_RDZAPACE,  143,   PP_TRIXIE    | CMD_OBJECTHERE,  "Rainbow Trash saw him at the clearing and an opportunity to permanently retire him from the race. She gathered some storm clouds, and 'boom!' fried Ace Swift!"   },

{EV_O_BADTRIXIE1,143,   PP_TRIXIE   | CMD_BADOBJECT, "" },
{EV_O_GOODTRIXIE1,143,  PP_TRIXIE   | CMD_GOODOBJECT, "" },

// Run cross examination
{   EV_NONE,        143,  PP_TRIXIE | CMD_MUSSCHESS,  ""  },
{ EV_T_TRIXIECROSS1,143,  PP_TRIXIE | CMD_STARTCROSS, "" },

{EV_P_RDEVERFREE,164,   PP_PHOENIX   | CMD_PHOENIXHOLD,    "HOLD IT!"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "How can you be sure she was there?"   },
{   EV_NONE,     135,   PP_TRIXIE    | CMD_NONE,    "Weren't you listening to what Trixie said earlier?"   },
{   EV_NONE,     144,   PP_TRIXIE    | CMD_NONE,    "The cloud above the crime scene had her hoof markings."   },
{   EV_NONE,     144,   PP_TRIXIE    | CMD_NONE,    "On top of that, some cyan-colored feathers were found around the clearing. Three guesses who they belong to, Mr Wrong."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "(Rainbow Dash, what were you doing there...?)"   },
{   EV_NONE,     128,   PP_PHOENIX   | CMD_NONE,    "Okay, continue."   },
{ EV_T_TRIXIECROSS1,128,  PP_PHOENIX| CMD_CONCROSS, "" },

{EV_P_RDSEEACE,  164,   PP_PHOENIX   | CMD_PHOENIXHOLD,    "HOLD IT!"   },
{   EV_NONE,     136,   PP_PHOENIX   | CMD_NONE,    "Why would he be 'hanging' around that forest anyway?"   },
{   EV_NONE,     135,   PP_TRIXIE    | CMD_NONE,    "That is of no concern to Trixie!"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "That's ridiculous! He had to have a reason to go into that dangerous forest!"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "If you think it's so important, why don't you give us an explanation?"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "I-I don't have one!"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "Thought so... now let Trixie continue."   },
{   EV_NONE,     132,   PP_TWILIGHT  | CMD_NONE,    "Do you think it's important why he was in there?"   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "I know for a fact there must have been a good reason why he was in a place like that."   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "I just don't know why yet... I wish I had more time to prepare."   },
{   EV_NONE,     132,   PP_TWILIGHT  | CMD_NONE,    "I guess it's my fault for getting you on such short notice."   },
{   EV_NONE,     177,   PP_PHOENIX   | CMD_NONE,    "We're not going to let that stop us though."   },
{   EV_NONE,     133,   PP_TWILIGHT  | CMD_NONE,    "Right!"   },
{   EV_NONE,     128,   PP_PHOENIX   | CMD_NONE,    "Alright Trixie, continue your explanation."   },
{ EV_T_TRIXIECROSS1,128,  PP_PHOENIX| CMD_CONCROSS, "" },

{EV_O_BADTRIXIE1,138,   PP_PHOENIX   | CMD_PHOENIXOBJ,  "OBJECTION!"   },
{   EV_NONE,     128,   PP_PHOENIX   | CMD_NONE,    "You can't seriously believe that's what happened!"   },
{   EV_NONE,     135,   PP_TRIXIE    | CMD_NONE,    "If you would let Trixie finish, it would all make sense!"   },
{   EV_NONE,     151,   PP_JUDGE     | CMD_NONE,    "Indeed, Mr Wright. Objection Overruled!"   },
{ EV_T_TRIXIECROSS1,128,  PP_PHOENIX| CMD_CONCROSS, "" },

{EV_P_RDZAPACE,  164,   PP_PHOENIX   | CMD_PHOENIXHOLD, "HOLD IT!"   },
{   EV_NONE,     136,   PP_PHOENIX   | CMD_NONE,    "You're saying Rainbow Dash saw Ace in the clearing that night, and saw it as an opportunity?"   },
{   EV_NONE,     144,   PP_TRIXIE    | CMD_NONE,    "That's right. It's a perfect theory!"   },
{ EV_T_TRIXIECROSS1,128,  PP_PHOENIX| CMD_CONCROSS, "" },

{ EV_T_TRIXIECROSS1,132,  PP_TWILIGHT  | CMD_NONE,  "Can you see any problems with Trixie's theory, Phoenix?"   },
{   EV_NONE,     136,   PP_PHOENIX   | CMD_NONE,    "There has to be something. I just need to pay close attention to the details!"   },
{ EV_T_TRIXIECROSS1,136,  PP_PHOENIX | CMD_STARTCROSS, "" },

{EV_O_GOODTRIXIE1,     138,   PP_PHOENIX   | CMD_PHOENIXOBJ,  "OBJECTION!"   },
{   EV_NONE,     141,   PP_TRIXIE    | CMD_NONE,    "Don't point that ugly sausage of a finger at Trixie!"   },
{   EV_NONE,     128,   PP_PHOENIX   | CMD_NONE,    "You say Rainbow Dash scoped the victim in the Everfree Forest that night and saw an opportunity to murder him."   },
{   EV_NONE,     135,   PP_TRIXIE    | CMD_NONE,    "Are you deaf? Of course Trixie did! Trixie is always right!"   },
{   EV_NONE,     128,   PP_PHOENIX   | CMD_NONE,    "Blind!"   },
{   EV_NONE,     135,   PP_TRIXIE    | CMD_NONE,    "What? Blind is not being able to see. Deaf is not being able to hear, you idiot!"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "No. Blind is how I felt in that forest last night. I couldn't see my hands in front of my face without a light source."   },
{   EV_NONE,     161,   PP_TRIXIE    | CMD_CHIMESFX, "!!!"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "Even Applebloom testified how dark it was."   },
{   EV_NONE,     148,   PP_PHOENIX   | CMD_MUSOBJECT,"How could Rainbow Dash see Ace Swift in that darkness and plot to murder him on impulse?"   },
{   EV_NONE,     149,   PP_PHOENIX   | CMD_NONE,    "Explain that, Trixie, that is if \"Trixie is always right\"!"   },
{   EV_NONE,     161,   PP_TRIXIE    | CMD_NONE,    "!!!"   },
{   EV_NONE,     133,   PP_TWILIGHT  | CMD_NONE,    "You got her, Phoenix!"   },
{   EV_NONE,     133,   PP_PHOENIX   | CMD_NONE,    "I just have to keep the momentum on my side now."   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "Is the forest truly that dark at that hour of the night, Ms Trixie?"   },
{   EV_NONE,     172,   PP_TRIXIE    | CMD_NONE,    "W-well yes..."   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "Then the defense has pointed out a flaw in your theory."   },
{   EV_NONE,     135,   PP_TRIXIE    | CMD_NONE,    "Why you! Are you mocking me!?"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "No, I'm just debunking your flawed theory."   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_STOPMUS, "Too bad Trixie has an explanation..."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "Care to share it with us?"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_MUSECHESS, "Rainbow Trash probably saw him enter the forest while he was still visible."   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_NONE,    "Yes, that's it!"   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "That makes sense."   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "She then followed him to the clearing and performed the dastardly deed."   },
{   EV_NONE,     141,   PP_TRIXIE    | CMD_NONE,    "It's dark in there, yes, but if you follow somepony from the entrance, it would be easy to track them using your other senses."   },
{   EV_NONE,     138,   PP_PHOENIX   | CMD_PHOENIXOBJ, "OBJECTION!"   },
{   EV_NONE,     148,   PP_PHOENIX   | CMD_STOPMUS, "Sorry Trixie, but that is impossible as well."   },
{   EV_NONE,     172,   PP_TRIXIE    | CMD_NONE,    "What do you mean!?"   },
{EV_T_WETLOOP,   149,   PP_PHOENIX   | CMD_NONE,    "This piece of evidence shows why that is impossible:"   },
                                                 //  012345678901234567890123456789010
{   EV_NONE,     149,   PP_PHOENIX   | CMD_SHOWEV,  "Prove impulse was impossible"   },
{EV_WEATHER, EV_T_SHOWEATHER,PP_PHOENIX | CMD_JUMPIFSHOW,  ""   },

{   EV_NONE,     135,   PP_TRIXIE    | CMD_NONE,    "You are the dumbest dummy Trixie has ever been forced to deal with! That has nothing to do with this!"   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "I'm afraid I don't see it either, Mr Wright. Do you have anything else?"   },
{   EV_NONE,     177,   PP_TWILIGHT  | CMD_NONE,    "Don't let her get to you, Phoenix! We must have something that proves Rainbow couldn't have attacked Ace on impulse without losing sight of him!"   },
{EV_T_WETLOOP,   177,   PP_TWILIGHT  | CMD_JUMP,  ""   },

{EV_T_SHOWEATHER,223,   PP_PHOENIX   | CMD_PHOENIXTAKE, "TAKE THAT!"   },
{   EV_NONE,     148,   PP_PHOENIX   | CMD_MUSOBJECT2,  "You said Rainbow Dash was scheduled to cause a storm on the eastern end of Ponyville, where you say she got the storm cloud from."   },
{   EV_NONE,     171,   PP_PHOENIX   | CMD_NONE,    "The Everfree Forest is in the west, according to this weather schedule you yourself submitted to this court!"   },
{   EV_NONE,     161,   PP_TRIXIE    | CMD_NONE,    "N-no!"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "There is no way my client could have flown to the other end of town and back to get a cloud while still tracking Ace in that dark forest!"   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "Mr Wright is correct. It would take some time to travel back and forth between the eastern and western ends of the town."   },
{   EV_NONE,     172,   PP_TRIXIE    | CMD_NONE,    "!!!"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_STOPMUS, "Thought you had Trixie there, didn't you?"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "What?"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "Premeditated..."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "You can't be seriously suggesting-"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "Yes, the defendant must have known he was going to be there, and unlike you, Mr Wrong..."   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_NONE,    "Trixie has proof!"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "Huh?"   },
{   EV_NONE,     142,   PP_TRIXIE    | CMD_NONE,    "The Great and Powerful Trixie would like to submit this evidence!"   },
{   EV_NONE,     178,   PP_JUDGE     | CMD_NONE,    "Hmmm... \"Missing Cloud Report\"?"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "Go on, read the rest, Your Honor."   },
{   EV_NONE,     178,   PP_JUDGE     | CMD_NONE,    "\"Storm cloud missing at 4:00PM from eastern end of Ponyville. Weather mare in charge: Rainbow Dash\""   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "This can't be!"   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_NONE,    "Take a guess where that missing cloud was found, Mr Wrong."   },
{   EV_NONE,     142,   PP_TRIXIE    | CMD_NONE,    "Right above the Everfree Forest clearing!"   },
{   EV_NONE,     124,   PP_NONE      | CMD_NONE,    "(crowd noise)"   },
{   EV_NONE,     130,   PP_JUDGE     | CMD_NONE,    "My word! So the defendant placed it there earlier? This makes all the defense's objections null and void."   },
{EV_CLOUDREPORT, 179,   PP_NONE      | CMD_ADDEV,   "Missing Cloud Report: A cloud Rainbow Dash was in charge of disappeared at 4pm on the night of the murder, and was found above the Everfree Forest clearing."   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "The defendant knew Ace was going to be in that forest, so she placed the cloud in that clearing well in advance."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_BOOMSFX, "But how could she know he would be there!?"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "Trixie will say this again, Mr Wrong:"   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_NONE,    "Who cares? The fact is she did it and that is all that matters."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "What if some other pony moved that cloud!?"   },
{   EV_NONE,     127,   PP_TRIXIE    | CMD_NONE,    "If that were the case, yes, you could argue another pony moved the cloud."   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_CLRPROMPT, "But the only two ponies in the clearing that night were Ace Swift and Rainbow Trash. Unless of course, you have proof there was another, Mr Wrong."   },

{ EV_T_YESAPONY, 143, PP_TRIXIE | CMD_ADDPROMPT, "I have evidence"     },
{ EV_T_NOAPONY,  143, PP_TRIXIE | CMD_ADDPROMPT, "I don't have evidence"    },
{   EV_NONE,     143, PP_TRIXIE | CMD_SELPROMPT, ""  },

{EV_T_YESAPONY,  177,   PP_TWILIGHT  | CMD_NONE,    "Phoenix, I've been through everything, I don't see any evidence that implicates another pony being there."   },
{   EV_NONE,     177,   PP_PHOENIX   | CMD_NONE,    "We'll have to see whether another opportunity comes up then..."   },

{EV_T_NOAPONY,   139,   PP_PHOENIX   | CMD_NONE,    "I don't right now!"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "Then it is to be assumed Rainbow Trash moved that cloud there in foresight that Ace would be there!"   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_HAMMERSFX,    "I have heard enough. With all the evidence supplied, I can safely hand down my verdict."   },
{   EV_NONE,     164,   PP_PHOENIX   | CMD_PHOENIXHOLD,  "HOLD IT!"   },
{   EV_NONE,     148,   PP_PHOENIX   | CMD_NONE,    "No, Your Honor, there still might be something we're overlooking."   },
{   EV_NONE,     127,   PP_TRIXIE    | CMD_NONE,    "The prosecution agrees..."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "(Huh? She is agreeing with me? Why?)"   },
{   EV_NONE,     127,   PP_TRIXIE    | CMD_NONE,    "Trixie still has some more evidence."   },
{   EV_NONE,     180,   PP_TRIXIE    | CMD_NONE,    "This!"   },
{   EV_NONE,     136,   PP_PHOENIX   | CMD_NONE,    "What is that?"   },
{   EV_NONE,     180,   PP_TRIXIE    | CMD_NONE,    "We found this in the victim's bag on the crime scene. A little burnt considering what happened, but the contents are still unharmed."   },
{   EV_NONE,     181,   PP_RAINBOW   | CMD_CHIMESFX, "!!!"   },
{   EV_NONE,     182,   PP_RAINBOW   | CMD_NONE,    "Huh!? NO! Please put that away!"   },
{   EV_NONE,     180,   PP_TRIXIE    | CMD_MUSTHRILL, "The contents of this envelope are quite shocking... no pun intended."   },
{   EV_NONE,     182,   PP_RAINBOW   | CMD_NONE,    "I'm begging you! Please don't open it!"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "Whatever is in that envelope really has Rainbow Dash spooked... what on earth is in there?"   },
{   EV_NONE,     142,   PP_TRIXIE    | CMD_NONE,    "Filles and Gentlecolts! Trixie will now reveal to the courtroom what secrets this mysterious envelope holds!"   },
{   EV_NONE,     182,   PP_RAINBOW   | CMD_NONE,    "Please don't do it, Trixie!"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "(I have a bad feeling about this. I hope whatever is in that thing doesn't hurt Rainbow Dash's case even more.)"   },
{   EV_NONE,     180,   PP_NONE      | CMD_STOPMUS, ""   },
{   EV_NONE,     180,   PP_NONE      | CMD_BLACK,   "(silence)"   },
{   EV_NONE,     139,   PP_GALLERY   | CMD_MUSINTEREST, "(laughter)"   },
{   EV_NONE,     183,   PP_GALLERY   | CMD_NONE,    "Wow! Rainbow Dash, who would have thought!"   },
{   EV_NONE,     143,   PP_GALLERY   | CMD_NONE,    "(more laughter)"   },
{   EV_NONE,     134,   PP_GALLERY   | CMD_NONE,    "I didn't know you were into that kind of stuff, Rainbow Dash!"   },
{   EV_NONE,     130,   PP_GALLERY   | CMD_NONE,    "M-my sides hurt!"   },
{   EV_NONE,     130,   PP_JUDGE     | CMD_NONE,    "My word... these are... certainly... Ahem. Interesting... photographs..."   },
{   EV_NONE,     134,   PP_PHOENIX   | CMD_NONE,    "Oh dear..."   },
{   EV_NONE,     184,   PP_TWILIGHT  | CMD_NONE,    "P-poor Rainbow Dash..."   },
{   EV_NONE,     185,   PP_RAINBOW   | CMD_NONE,    "My life is ruined!"   },
{   EV_NONE,     143,   PP_TRIXIE    | CMD_CLRPROMPT, "As you can see, the defendent has some very bizarre tastes."   },

{ EV_T_WHYSHOW,  143, PP_TRIXIE | CMD_ADDPROMPT, "Why show these?"     },
{ EV_T_WHYHAVE,  143, PP_TRIXIE | CMD_ADDPROMPT, "Why did Ace have these?"    },
{   EV_NONE,     143, PP_TRIXIE | CMD_SELPROMPT, ""  },

{ EV_T_WHYSHOW,  139,   PP_PHOENIX   | CMD_NONE,    "Wait! What was the point in showing these pictures? How do they relate to the crime in question?"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "They were in the victim's bag, weren't they?"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "They are important evidence! Do you think Trixie would be so low as to show these pictures for the sole purpose of humiliating the defendant?"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "(That is exactly what I think you did!)"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_SELPROMPT, ""  },

{EV_T_WHYHAVE,   139,   PP_PHOENIX   | CMD_NONE,    "What were pictures like... these... doing on the victim anyway?"   },
{   EV_NONE,     141,   PP_TRIXIE    | CMD_NONE,    "How should Trixie know?"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "(You said these pictures were important evidence, and you're not going to explain why?)"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "(Now I know you just brought them out to embarrass Rainbow Dash.)"   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "In any case, the court accepts these... um... photos as... evidence..."   },
{EV_PICTURES,    186,   PP_NONE      | CMD_ADDEV,   "Embarassing pictures: Several pictures of Rainbow Dash... why in her right mind would she be doing this? Photos found in a bag on the victim."   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_STOPMUS, "After that little sideshow... can I declare my verdict now?"   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "Most certainly, Your Honor!"   },
{   EV_NONE,     132,   PP_TWILIGHT  | CMD_MUSSUSPENSE, "Phoenix, do something quick!"   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "To be honest... I don't know WHAT to do!"   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "I've never encountered first degree murder with a storm cloud before."   },
{   EV_NONE,     132,   PP_TWILIGHT  | CMD_NONE,    "You said you wing it all the time, right? Well, wing it!"   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "In the case of Ms Rainbow Dash..."   },
{   EV_NONE,     164,   PP_PHOENIX   | CMD_PHOENIXHOLD, "HOLD IT!"   },
{   EV_NONE,     130,   PP_JUDGE     | CMD_NONE,    "What is it, Mr Wright?"   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "How are you so sure my... um... my client was at the scene of the crime?"   },
{   EV_NONE,     128,   PP_PHOENIX   | CMD_NONE,    "If I recall correctly, she was picked up at her house... not on location."   },
{   EV_NONE,     141,   PP_TRIXIE    | CMD_NONE,    "Trixie already explained that, you imbecile."   },
{   EV_NONE,     141,   PP_TRIXIE    | CMD_NONE,    "Her hoof marks were on the cloud and her feathers were all over the place. You don't think that's incriminating enough?"   },
{   EV_NONE,     148,   PP_PHOENIX   | CMD_NONE,    "Yes, but the cloud could have been moved by someone else and feathers could have been gathered from anywhere, just as hair falls from your head."   },
{   EV_NONE,     139,   PP_PHOENIX   | CMD_NONE,    "I may not have proof yet, but it is a possibility!"   },
{   EV_NONE,     141,   PP_TRIXIE    | CMD_STOPMUS, "Looks like this is going to drag out a bit longer."   },
{   EV_NONE,     176,   PP_TRIXIE    | CMD_NONE,    "Trixie has another witness that can confirm the defendant was indeed at the scene of the crime on the night of the murder."   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "This one HAS to be Fluttershy."   },
{   EV_NONE,     132,   PP_TWILIGHT  | CMD_NONE,    "I wonder what she saw..."   },
{   EV_NONE,     132,   PP_PHOENIX   | CMD_NONE,    "We're about to find out in any case..."   },
{   EV_NONE,     126,   PP_JUDGE     | CMD_NONE,    "The prosecution will bring out their next witness."   },

{   16,           94,   PP_NONE      | CMD_ENDSTORY, ""  }   // go to location 16
};
#endif
...
const Story_t story[] =  {                           //  
    ...
    {EV_NONE, 188, PP_FLUTTERSHY | CMD_NONE, "*whisper*"},
...
// =============================================================================
    ...
    {EV_P_FNIGHTCHICKENS,   191, PP_FLUTTERSHY | CMD_ADDTEST, "It was during the night hours. I went outside to feed the chickens and the other ones..."},
    {EV_P_FLIGHTNING,       190, PP_FLUTTERSHY | CMD_ADDTEST, "When I was near my chicken coop, I heard a lightning bolt in the distance and it scared me."},
    {EV_P_FSAWDASH,         193, PP_FLUTTERSHY | CMD_ADDTEST, "After I finished feeding my chickens, I saw Rainbow Dash flying away from the forest like something was chasing her. I called out to her, but I don't think she heard me."},
    {EV_P_FNOFOLLOW,        193, PP_FLUTTERSHY | CMD_ADDTEST, "I looked up but saw nothing following her."},
    {EV_P_FPOLICE,          191, PP_FLUTTERSHY | CMD_ADDTEST, "That was when the police ponies arrived. They spoke with me, and I went off to bed at 10:30PM."},

{EV_O_BADFLUT, 192, PP_NONE | CMD_BADOBJECT, "" },
...
// Objection handlers
{EV_O_BADFLUT, 138,    PP_PHOENIX | CMD_PHOENIXOBJ, "OBJECTION!" },
{EV_O_BADFLUT2, 139, PP_PHOENIX | CMD_BADOBJECT, "I object to the witness feeding chickens at night!"},
{EV_NONE, 135, PP_TRIXIE | CMD_NONE, "What's wrong with that, Mr Wrong?"},
{EV_NONE, 134, PP_PHOENIX | CMD_NONE, "Because... uh... lawyers don't feed chickens at night?"},
{EV_NONE, 126, PP_JUDGE | CMD_NONE, "Mr Wright, that makes absolutely no sense whatsoever."},
{EV_NONE, 137, PP_PHOENIX | CMD_NONE, "Yeah, I thought that was weak even for me..."},
{EV_NONE, 169, PP_JUDGE | CMD_NONE, "Objection Overruled!"},
{ EV_T_FLUTCROSS,169, PP_JUDGE  | CMD_CONCROSS, "" },
...
{ EV_T_FLUTCROSS,176, PP_TRIXIE | CMD_CONCROSS, "" },
    ...
    {EV_P_FNIGHTCHICKENS, 164, PP_PHOENIX | CMD_PHOENIXHOLD, "HOLD IT!"},
    ...
    {EV_NONE, 189, PP_FLUTTERSHY | CMD_NONE, "A zoo in Fillydelphia is renovating, and they needed a place for all the animals to stay while they do it."},
    {EV_NONE, 191, PP_FLUTTERSHY | CMD_NONE, "They heard about my talent with animals, and they came to me and asked me to take care of them."},
    {EV_NONE, 189, PP_FLUTTERSHY | CMD_CLRPROMPT, "Of course I said 'yes', since they had lots of birdies and critters that I've never seen before, and I always like to meet new animals!"},

    {EV_T_FHOWLONG, 136, PP_PHOENIX | CMD_ADDPROMPT, "How long have you had them?"},
    {EV_T_FHARDWORK, 136, PP_PHOENIX | CMD_ADDPROMPT, "Is it hard work?"},
    {EV_NONE, 136, PP_PHOENIX | CMD_SELPROMPT, ""},

    {EV_T_FHOWLONG, 136, PP_PHOENIX | CMD_NONE, "How long have you had these animals?"},
    ...
    {EV_I_FLUTTERANIMALS, 139, PP_PHOENIX | CMD_ADDEV, "(I better keep note of these exotic animals, though, something about it...)"},
    ...
    {EV_P_FLIGHTNING, 164, PP_PHOENIX | CMD_PHOENIXHOLD, "HOLD IT!"},
    {EV_NONE, 139, PP_PHOENIX | CMD_NONE, "You heard thunder while you were in your chicken coop?"},
    {EV_NONE, 190, PP_FLUTTERSHY | CMD_CLRPROMPT, "Well, it was lightning..."},

    {EV_T_FCORRECTL, 190, PP_FLUTTERSHY | CMD_ADDPROMPT, "Correct her"},
    {EV_T_FNOCORRECTL, 190, PP_FLUTTERSHY | CMD_ADDPROMPT, "No, she is correct"},
    {EV_NONE, 190, PP_FLUTTERSHY | CMD_SELPROMPT, ""},

    {EV_T_FCORRECTL, 139, PP_PHOENIX | CMD_NONE, "No, Fluttershy, thunder produces the sound, not lightning."},
    ...
    {EV_NONE, 139, PP_PHOENIX | CMD_NONE, "That wasn't what I wanted to say, anyway."},

    {EV_T_FNOCORRECTL, 139, PP_PHOENIX | CMD_NONE, "What time was it when you heard it?"},
    ...
    { EV_T_FLUTCROSS, 127, PP_TRIXIE | CMD_CONCROSS, "" },
    ...
    {EV_P_FSAWDASH, 164, PP_PHOENIX | CMD_PHOENIXHOLD, "HOLD IT!"},
    ...
    {EV_I_FLUTTERANIMALS, EV_T_FGOTANIMALS, PP_FLUTTERSHY | CMD_JUMPIFEV, "" },

    // if we didn't get the animals earlier, make sure we get them now. We need to have seen this.
    {EV_NONE, 139, PP_PHOENIX | CMD_NONE, "Could you have been distracted by anything? Maybe your animals?"},
    {EV_NONE, 189, PP_FLUTTERSHY | CMD_NONE, "Oh no, Mr Phoenix. All the zoo animals I'm watching have very early bedtimes and were fast asleep by then!"},
    {EV_NONE, 136, PP_PHOENIX | CMD_NONE, "Zoo animals?"},
    {EV_NONE, 189, PP_FLUTTERSHY | CMD_NONE, "A zoo in Fillydelphia is renovating, and they needed a place for all the animals to stay while they do it."},
    {EV_NONE, 189, PP_FLUTTERSHY | CMD_NONE, "But they are really well behaved and didn't make a fuss all night! So I wasn't distracted at all."},

    {EV_T_FGOTANIMALS, 139, PP_PHOENIX | CMD_NONE, "!!??"},
    ...
    {EV_P_FNOTHINGELSE, 191, PP_FLUTTERSHY | CMD_OBJECTHERE, "I didn't see or hear anything else come out of the forest that night."},
    { EV_T_FLUTCROSS, 139, PP_PHOENIX | CMD_CONCROSS, "" },

    // STATEMENT 5: "That was when the police ponies arrived. They spoke with me, and I went off to bed at 10:30PM."
    {EV_P_FPOLICE, 164, PP_PHOENIX | CMD_PHOENIXHOLD, "HOLD IT!"},
    {EV_NONE, 139, PP_PHOENIX | CMD_NONE, "Was there anything else you could have told the police?"},
    {EV_NONE, 190, PP_FLUTTERSHY | CMD_NONE, "I don't think so... I had to get up early to take care of my animals."},
    { EV_T_FLUTCROSS2, 139, PP_PHOENIX | CMD_CONCROSS, "" },

    // fell out of cross examine
    {EV_T_FLUTCROSS, 132, PP_TWILIGHT | CMD_NONE, "Was there anything in there you could work with?"},
    {EV_NONE, 136, PP_PHOENIX | CMD_NONE, "Maybe... I need to press every statement until I find something that doesn't line up."},
...
// =============================================================================
    ...
    {EV_P_FNOTHINGELSE, 164, PP_NONE | CMD_PHOENIXHOLD, "HOLD IT!"},
    ...
    {EV_T_FLUTCROSS2, 136, PP_PHOENIX | CMD_NONE, "I feel like I'm missing something... something about that last statement rubs me the wrong way."},
    {EV_NONE, 132, PP_TWILIGHT | CMD_NONE, "Do you think she should have seen something?"},
    { EV_T_FLUTCROSS, 136, PP_PHOENIX | CMD_STARTCROSS, "" },
...
{   PP_RAINBOW,EV_T_FSEERD, PP_PHOENIX|CMD_JUMPIFSHOW, "" },
    ...
    {   17,   125, PP_NONE  | CMD_ENDSTORY, ""  },   // loop back to THIS location 17    
...
{   18,       143, PP_TRIXIE | CMD_ENDSTORY, ""  }   // go to location 18
...
// =============================================================================
    {EV_NONE, 151, PP_JUDGE | CMD_BOOMSFX, "Enough! I'm afraid the defense's line has run short. Do you have anything else you would like to say, Mr Wright, before I hand down my verdict?"},
    {EV_NONE, 139, PP_PHOENIX | CMD_MUSSUSPENSE, "(I'm going to lose if I don't do something fast!!)"},
    ...
    {EV_NONE, 198, PP_PHOENIX | CMD_NONE, "(There is one thing I can do... I didn't want to do it earlier, but I have no choice... )"},
    {EV_NONE, 199, PP_PHOENIX | CMD_NONE, "(I need more time and evidence... this is the only way...)"},
    {EV_NONE, 148, PP_PHOENIX | CMD_CRASHSFX, "Your Honor!"},
    ...
    {EV_T_FFINALMISS, 199, PP_PHOENIX | CMD_RESETMISS, "(There's only one other pony who fits what we know about the crime...)"},
...
{   PP_RAINBOW,EV_T_FACCRD, PP_PHOENIX|CMD_JUMPIFSHOW, "" },
    ...
    {EV_T_JUDGERETRY, 151, PP_JUDGE | CMD_MISS, "Do you want to rethink your accusation?"},
    ...
    {EV_T_JUDGERETRY, 135, PP_TRIXIE | CMD_JUMP, "" },  // MISS is handled in JUDGERETRY
    ...
    {EV_NONE, 137, PP_PHOENIX | CMD_MISS, "Sorry... I got a little carried away. What I meant to say was:"},
    {EV_NONE, 137, PP_PHOENIX | CMD_MUSSUSPENSE, "" },   // restart the music
    {EV_T_LOOPFWHO2, 137, PP_PHOENIX | CMD_JUMP, "" },

    // out of misses
    {EV_T_FFINALMISS, 151, PP_JUDGE | CMD_STOPMUS, "I'm sorry, but this court will not permit any more stalling on this question."},
    {EV_NONE, 151, PP_JUDGE | CMD_NONE, "The prosecution has provided convincing evidence which the defense has been unable to refute."},
    {EV_NONE, 143, PP_TRIXIE | CMD_NONE, "Of course. Trixie provided a perfect case!"},
    {EV_NONE, 151, PP_JUDGE | CMD_NONE, "I find the defendent, Ms Rainbow Dash:"},
    {EV_NONE, 201, PP_JUDGE | CMD_BOOMSFX, "GUILTY"},
    {EV_NONE, 129, PP_PHOENIX | CMD_NONE, "!!!"},
    {EV_NONE, 126, PP_JUDGE | CMD_NONE, "Court is now adjourned."},
    {EV_NONE, 125, PP_NONE  | CMD_HAMMERSFX, "Don't give up! Press 'N' to retry chapter, or '7' then 'S' to save game." },
    {   18,  125,  PP_NONE  | CMD_ENDSTORY, ""  },   // loop back to THIS location 18

    // correct: accuse Fluttershy
    {EV_T_FACCFS, 148, PP_PHOENIX | CMD_STOPMUS, "The defense accuses the witness, Fluttershy!"},
    {EV_NONE, 191, PP_FLUTTERSHY | CMD_MUSFALL, "Huh?"},
    {EV_NONE, 132, PP_TWILIGHT | CMD_STOREMISS, "Mr Wright! What are you doing!?"},
    ...
    {EV_NONE, 126, PP_JUDGE | CMD_RECALLMISS, "You're going to need more proof to accuse this witness, Mr Wright. Do you have any evidence that can place her on the crime scene?"},
    {EV_NONE, 139, PP_PHOENIX | CMD_NONE, "In fact I do, Your Honor."},

    //                                       0123456789012345678901234567890101
{   EV_T_LOOPFSHOW,  139, PP_PHOENIX | CMD_NONE, "" },
{   EV_NONE,  139, PP_PHOENIX | CMD_SHOWEV, "What MAY place her on the scene?"   },
{   EV_FEATHER,EV_T_FFEATHER, PP_PHOENIX|CMD_JUMPIFSHOW, "" }, 

    {EV_NONE, 126, PP_JUDGE | CMD_NONE, "I don't see it, Mr Wright. How does THIS place Fluttershy on the crime scene?" },
    {EV_NONE, 134, PP_PHOENIX | CMD_NONE, "I... uh... guess it doesn't..."},
    {EV_NONE, 143, PP_TRIXIE | CMD_MISS, "Do you want to try again, Mr Wrong?"},
    {EV_T_LOOPFSHOW,  143, PP_TRIXIE | CMD_JUMP, "" },

    {EV_T_FFEATHER,    223,    PP_PHOENIX| CMD_PHOENIXTAKE,  "TAKE THAT!"  },
    {EV_NONE, 130, PP_JUDGE | CMD_STOREMISS, "A feather? Does it belong to her?"},
    ...
    {EV_NONE, 148, PP_PHOENIX | CMD_STOPMUS, ""},
    {EV_NONE, 138, PP_TWILIGHT| CMD_TWIOBJ, "OBJECTION!"},
    {EV_NONE, 130, PP_JUDGE | CMD_BOOMSFX, "!!!"},
    {EV_NONE, 141, PP_TRIXIE | CMD_BOOMSFX, "..."},
    ...
    {EV_NONE, 143, PP_TRIXIE | CMD_CHIMESFX, "Trixie agrees, Fluttershy is suspicious."},
    ...
    {EV_NONE, 126, PP_JUDGE | CMD_MUSTRIAL, "All proceedings for this case will be suspended until tomorrow."},
...
{   19,        125, PP_NONE   | CMD_ENDSTORY, ""  }   // go to location 19
...
{   20,         94,     PP_NONE         | CMD_ENDSTORY, ""  }   // go to location 20
