...
{   EV_NONE,     6,  PP_UNKNOWN | CMD_NONE,      "A human in Equestria, that's amazing!"  },
...
{   EV_NONE,     13, PP_TWILIGHT | CMD_NONE,     "*Sigh*"  },
...
{   EV_NONE,     6 , PP_TWILIGHT | CMD_NONE,     "Really! So you'll take the case?!"  },
