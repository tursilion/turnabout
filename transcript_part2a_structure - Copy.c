...
ConversationEntry transcript_part2a[] = {
    ...
    {EV_NONE, 132, PP_PHOENIX | CMD_NONE, "(I actually hope she's lying so I have something to work off of.)"},
    ...
    {EV_NONE, 143, PP_TRIXIE | CMD_NONE, "Even if we take your silly theory into consideration, the odds of him being struck down by a random bolt of lightning are too low to be believable without having"},
    {EV_NONE, 143, PP_TRIXIE | CMD_NONE, "some sort of concrete proof!"},
    {EV_NONE, 126, PP_JUDGE | CMD_NONE, "The prosecution's logic is very sound."},
    {EV_NONE, 126, PP_JUDGE | CMD_NONE, "The chances of a lightning bolt hitting the victim by chance are too small to hold water in this court without any proof,"},
    {EV_NONE, 126, PP_JUDGE | CMD_NONE, "considering the protection he was wearing."},
